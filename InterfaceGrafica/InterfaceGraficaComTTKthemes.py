...
caminho_icone = "TkInterBasico/img/icons/cash.ico"
...
label = ttk.Label(janela, text="Olá, Tkinter!")
label.pack()
...
opcao1 = ttk.Checkbutton(janela, text="Opção 1 Caixa de Seleção")
opcao2 = ttk.Checkbutton(janela, text="Opção 2 Caixa de Seleção")
opcao1.pack()
opcao2.pack()

# Adiciona uma Caixa de opções à janela
opcao1 = ttk.Radiobutton(janela, text="Opção 1 Caixa de Opções", value=1)
opcao2 = ttk.Radiobutton(janela, text="Opção 2 Caixa de Opções", value=2)
opcao1.pack()
opcao2.pack()
...
# Carrega a imagem 
imagem = PhotoImage(file="TkInterBasico/img/imagens/imagem3.png")
...
label_imagem = ttk.Label(janela, image=imagem_redimensionada)
label_imagem.pack()


#Ajutar posição do Widget
# Cria um botão e o posiciona nas coordenadas (100, 50) da janela
botao2 = ttk.Button(janela, text="Clique Aqui!")
...
label_mensagem = ttk.Label(janela, text="")
label_mensagem.pack()


# Carrega a imagem do botão
imagem_botao = tk.PhotoImage(file="TkInterBasico/img/imagens/botao.png")
